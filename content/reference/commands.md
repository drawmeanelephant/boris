...
The public CLI has a small set of commands plus the `nostr` and
`standard-site` families. With no command, Boris runs `build` and publishes
an HTML site under `dist/`.
