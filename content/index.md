...
**Product v0.6.0.** Bare `boris` builds HTML under `dist/` with **ApexMarkdown
...
Includes and wiki-links expand on this path before Apex runs. Same binary also
offers `--context`, `check`, and `impact` (see [[getting-started]]).
