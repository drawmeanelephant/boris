...
| Tables | Compact comparisons and reference data | Oliver GFM tables; theme supplies presentation |
| Footnotes | Method notes without interrupting the main argument | Oliver footnote refs + section |
| Definition lists | Glossary-style term/definition pairs | Oliver definition lists |
| Heading IAL | Stable custom anchors and classes | Oliver heading attributes; TOC reads rendered ids |
