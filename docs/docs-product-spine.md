...
| `content/guides/editor.md` | Content Authors | How do I use the local Boris Editor's advanced authoring features? | Launch the editor, complete against the schema and graph, run Boris commands, preview | Compiler-Backed Authoring Environment | Authoring Guides | Leads with **User Value** |
