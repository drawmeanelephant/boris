...
The file is not linked exclusively into tests. It is a normal module dependency of production modules. It has no direct tie to `src/render.zig` — Markdown rendering is a separate concern handled downstream of `PageDb`.
