# CHANGELOG archive — pre-0.8.0 (historical)

> **Archived 2026-08-21 — issue [#691](https://github.com/drawmeanelephant/boris/issues/691).**
> This file was moved from [`CHANGELOG.md`](../../CHANGELOG.md) to
> `docs/archived/CHANGELOG-pre-0.8.md` as a historical record.
> `CHANGELOG.md` now keeps only `[Unreleased]` and `[0.8.0]` (latest release)
> to reduce agent context. Do not load this file as standing agent context.
> Git history preserves the full file; this snapshot keeps pre-0.8.0 history
> reachable without restoring the whole document.

**As of:** 2026-07-21 · `v0.8.1 candidate` / `boris/0.8.1` · base IR `0.2.0` ·
historical record · source revision: `CHANGELOG.md` as of 2026-08-21,
afterparty tip PR #704 / #703 (≈1323 lines, 1243 archived).
