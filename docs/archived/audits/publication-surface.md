...
> This file was moved from `docs/audits/publication-surface.md` to `docs/archived/audits/publication-surface.md`
...
| RAG corpus | Opt-in machine edition | content/frontmatter; working-context packs + complete corpus; scope controls; checked-in system seeds | `--rag`, `--rag-dir`, `--complete`, `--scope`, `--split-size` | `rag/` by default | No |
