...
This documents the verified **v0.5.1** release gate. Tag `v0.5.1` points at
the certified PR #127 merge commit that passed these checks; do not re-tag.
...
[`docs/STATUS.md`](STATUS.md). Product **v0.5.1** / base IR
