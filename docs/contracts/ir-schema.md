...
**Target product / compiler id:** `0.7.0` / `boris/0.7.0`
**schemaVersion:** `0.2.0`
...
The v0.7.0 compiler emits this unchanged dependency shape with
`schemaVersion: "0.2.0"` and compiler id `boris/0.7.0`.
...
`boris/<product-version>` (target `boris/0.7.0`). Product version bumps may
...
| `compiler` | string | yes | e.g. `"boris/0.7.0"` |
