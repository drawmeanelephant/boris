...
**Target product / compiler id:** `0.6.1` / `boris/0.6.1`
**schemaVersion:** `0.2.0`
...
The v0.6.1 compiler emits this unchanged dependency shape with
`schemaVersion: "0.2.0"` and compiler id `boris/0.6.1`.
...
`boris/<product-version>` (target `boris/0.6.1`). Product version bumps may
...
| `compiler` | string | yes | e.g. `"boris/0.6.1"` |
