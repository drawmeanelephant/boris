...
[`publication-checks.md`](publication-checks.md) for the authority of those
observations.
...
[`schemas/publication-claims-1.schema.json`](schemas/publication-claims-1.schema.json).
