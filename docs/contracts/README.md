...
| AT Protocol OAuth core | **Implemented foundation** — host-independent PKCE, P-256 JWK/thumbprints, and ES256 DPoP primitives with a freestanding compile gate; see [atproto-oauth.md](atproto-oauth.md) |
...
| [atproto-oauth.md](atproto-oauth.md) | Host-independent PKCE, P-256 JWK/thumbprint, ES256 DPoP, and future local-interactive adapter boundary |
