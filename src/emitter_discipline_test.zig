...
const modules = [_]Module{
    ...
    .{ .name = "publication_evidence.zig", .class = .other },
    .{ .name = "publication_json_stream.zig", .class = .other },
    .{
        .name = "publication_evidence_state.zig",
        .class = .other,
        .source = @embedFile("publication_evidence_state.zig"),
    },
    .{ .name = "proof_pack_html.zig", .class = .other },
    .{ .name = "proof_pack_json.zig", .class = .other },
    .{ .name = "proof_pack_transaction.zig", .class = .other },
    .{ .name = "touches_graph.zig", .class = .other },
    .{ .name = "touches_parse.zig", .class = .other },
